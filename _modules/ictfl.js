...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "link svelte-w3oef5");
		},
		m(target, anchor) {
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*link*/ ctx[16].url);
			attr(a, "class", "svelte-w3oef5");
			toggle_class(a, "button", /*cta*/ ctx[2].length - 1 === /*i*/ ctx[18]);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
			append_hydration(a, t);
		...
		p(ctx, dirty) {
			if (dirty & /*cta*/ 4 && t_value !== (t_value = /*link*/ ctx[16].label + "")) set_data(t, t_value);

			if (dirty & /*cta*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[16].url)) {
				attr(a, "href", a_href_value);
			}
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-w3oef5");
			attr(hr, "class", "svelte-w3oef5");
			...
			attr(svg, "class", "svelte-w3oef5");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-w3oef5");
			attr(nav_1, "id", "mobile-nav");
			attr(nav_1, "class", "svelte-w3oef5");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-w3oef5");
			attr(div0, "class", "call-to-action svelte-w3oef5");
			attr(div1, "class", "section-container svelte-w3oef5");
			attr(header, "class", "svelte-w3oef5");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('fcnrb' in $$props) $$invalidate(6, fcnrb = $$props.fcnrb);
		if ('ikshv' in $$props) $$invalidate(7, ikshv = $$props.ikshv);
		if ('nsgbc' in $$props) $$invalidate(8, nsgbc = $$props.nsgbc);
		if ('ijbib' in $$props) $$invalidate(9, ijbib = $$props.ijbib);
		if ('mpmpu' in $$props) $$invalidate(10, mpmpu = $$props.mpmpu);
		if ('blalq' in $$props) $$invalidate(11, blalq = $$props.blalq);
		if ('ggfat' in $$props) $$invalidate(12, ggfat = $$props.ggfat);
