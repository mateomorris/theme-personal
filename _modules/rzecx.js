...
function create_each_block(ctx) {
	...
	let t;
	let current;
	icon = new Component({ props: { icon: /*icon*/ ctx[11] } });
	...
	return {
		...
		h() {
			...
			attr(a, "aria-label", a_aria_label_value = /*icon*/ ctx[11]);
			attr(a, "class", "svelte-ofif72");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[11];
			icon.$set(icon_changes);

			if (!current || dirty & /*social*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[10].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social*/ 1 && a_aria_label_value !== (a_aria_label_value = /*icon*/ ctx[11])) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "svelte-ofif72");
			attr(a, "href", "https://primo.so");
			attr(a, "class", "svelte-ofif72");
			attr(span, "class", "primo svelte-ofif72");
			attr(div, "class", "section-container svelte-ofif72");
			attr(footer, "class", "svelte-ofif72");
		},
		m(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('fcnrb' in $$props) $$invalidate(3, fcnrb = $$props.fcnrb);
		if ('ikshv' in $$props) $$invalidate(4, ikshv = $$props.ikshv);
		if ('nsgbc' in $$props) $$invalidate(5, nsgbc = $$props.nsgbc);
		if ('ijbib' in $$props) $$invalidate(6, ijbib = $$props.ijbib);
		if ('mpmpu' in $$props) $$invalidate(7, mpmpu = $$props.mpmpu);
		if ('blalq' in $$props) $$invalidate(8, blalq = $$props.blalq);
		if ('ggfat' in $$props) $$invalidate(9, ggfat = $$props.ggfat);
